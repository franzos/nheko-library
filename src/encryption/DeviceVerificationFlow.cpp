  ...
  , model_(model)
{
    ...
    if (model) {
        connect(
          this->model_, &Timeline::updateFlowEventId, this, [this](std::string event_id_) {
    ...
    connect(Client::instance(),
            &Client::receivedDeviceVerificationAccept,
            this,
    ...
    connect(
      Client::instance(),
      &Client::receivedDeviceVerificationMac,
      this,
    ...
    connect(Client::instance(),
            &Client::receivedDeviceVerificationDone,
            this,
...
{
    QSharedPointer<DeviceVerificationFlow> flow(
      new DeviceVerificationFlow(parent_, Type::RoomMsg, timeline_, userid, {}));
    flow->sender = true;
    return flow;
}
